...
kubectl create namespace spark_operator
#Create serviceaccount for spark operator
kubeclt create serviceaccount spark --namespace=default
...
helm install spark incubator/spark_operator --namespace spark-operator --set sparkJobNamespace=default
